...
print("Test 1: IP not given, condition=ip is_empty")
print(is_stage_applicable({"conditionField": "ip", "conditionOperator": "is_empty"}, {"details": {}}))

print("Test 2: IP given, condition=ip is_empty")
print(is_stage_applicable({"conditionField": "ip", "conditionOperator": "is_empty"}, {"details": {"ip": "1.1.1.1"}}))
