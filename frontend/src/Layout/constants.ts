...
export const SIDEBAR_OPTIONS = [
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "Server Monitoring", privileges: [PRIVILEGES.SERVER_MONITORING_VIEW, PRIVILEGES.SERVER_MONITORING_CREATE, PRIVILEGES.SERVER_MONITORING_UPDATE, PRIVILEGES.SERVER_MONITORING_DELETE] },
