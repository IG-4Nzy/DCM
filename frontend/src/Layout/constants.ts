...
export const SIDEBAR_OPTIONS = [
    ...
    {
        label: wordings.usersAndRoles,
        icon: Icons.UsersIcon,
        route: ROUTE_CONSTANTS.USERS,
        privileges: [
            PRIVILEGES.USER_VIEW_ALL, PRIVILEGES.USER_VIEW_DEPT, PRIVILEGES.USER_CREATE, PRIVILEGES.USER_UPDATE, PRIVILEGES.USER_DELETE,
            PRIVILEGES.ROLE_VIEW, PRIVILEGES.ROLE_CREATE, PRIVILEGES.ROLE_UPDATE, PRIVILEGES.ROLE_DELETE,
            PRIVILEGES.DEPARTMENT_VIEW, PRIVILEGES.DEPARTMENT_CREATE, PRIVILEGES.DEPARTMENT_UPDATE, PRIVILEGES.DEPARTMENT_DELETE
        ]
    },
    {
    ...
    },
    {
        ...
        privileges: [
            PRIVILEGES.OBSERVATION_VIEW, PRIVILEGES.OBSERVATION_VIEW_ALL_DEPT, PRIVILEGES.OBSERVATION_CREATE, PRIVILEGES.OBSERVATION_UPDATE, PRIVILEGES.OBSERVATION_DELETE,
            PRIVILEGES.VISITOR_LOGS_VIEW, PRIVILEGES.VISITOR_LOGS_CREATE, PRIVILEGES.VISITOR_LOGS_UPDATE, PRIVILEGES.VISITOR_LOGS_DELETE
        ]
    },
    {
    ...
    },
    {
        ...
        privileges: [
            PRIVILEGES.SERVER_MONITORING_VIEW, PRIVILEGES.SERVER_MONITORING_CREATE, PRIVILEGES.SERVER_MONITORING_UPDATE, PRIVILEGES.SERVER_MONITORING_DELETE,
            PRIVILEGES.SERVER_PING_MONITORING_VIEW, PRIVILEGES.SERVER_PING_MONITORING_CREATE, PRIVILEGES.SERVER_PING_MONITORING_UPDATE, PRIVILEGES.SERVER_PING_MONITORING_DELETE
        ]
    },
    {
    ...
    {
        label: wordings.ipAndPhoneDirectory,
        icon: Icons.IpListIcon,
        route: ROUTE_CONSTANTS.IP_LIST,
        privileges: [PRIVILEGES.IP_LIST_VIEW, PRIVILEGES.PHONE_DIRECTORY_VIEW]
    },
    {
