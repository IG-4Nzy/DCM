...
export const SIDEBAR_OPTIONS = [
    ...
    },
    {
        ...
        privileges: [PRIVILEGES.BMS_CHECKLIST_VIEW, PRIVILEGES.BMS_CHECKLIST_CREATE, PRIVILEGES.BMS_CHECKLIST_UPDATE, PRIVILEGES.BMS_CHECKLIST_DELETE, PRIVILEGES.MORNING_CHECKLIST_VIEW, PRIVILEGES.MORNING_CHECKLIST_CREATE, PRIVILEGES.MORNING_CHECKLIST_UPDATE, PRIVILEGES.MORNING_CHECKLIST_DELETE]
    },
    {
