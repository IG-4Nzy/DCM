...
export const SIDEBAR_OPTIONS = [
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "Users", privileges: [PRIVILEGES.USER_VIEW_ALL, PRIVILEGES.USER_VIEW_DEPT, PRIVILEGES.USER_CREATE, PRIVILEGES.USER_UPDATE, PRIVILEGES.USER_DELETE] },
            { label: "Roles", privileges: [PRIVILEGES.ROLE_VIEW, PRIVILEGES.ROLE_CREATE, PRIVILEGES.ROLE_UPDATE, PRIVILEGES.ROLE_DELETE] },
            { label: "Departments", privileges: [PRIVILEGES.DEPARTMENT_VIEW, PRIVILEGES.DEPARTMENT_CREATE, PRIVILEGES.DEPARTMENT_UPDATE, PRIVILEGES.DEPARTMENT_DELETE] }
        ]
    },
    {
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "Observations", privileges: [PRIVILEGES.OBSERVATION_VIEW, PRIVILEGES.OBSERVATION_VIEW_ALL_DEPT, PRIVILEGES.OBSERVATION_CREATE, PRIVILEGES.OBSERVATION_UPDATE, PRIVILEGES.OBSERVATION_DELETE] },
            { label: "Visitor Logs", privileges: [PRIVILEGES.VISITOR_LOGS_VIEW, PRIVILEGES.VISITOR_LOGS_CREATE, PRIVILEGES.VISITOR_LOGS_UPDATE, PRIVILEGES.VISITOR_LOGS_DELETE] }
        ]
    },
    {
    ...
    },
    {
        ...
        privileges: [
            ...
            PRIVILEGES.RACKS_VIEW,
            PRIVILEGES.CLUSTER_VIEW_TAB,
            PRIVILEGES.NODES_VIEW,
            PRIVILEGES.VM_VIEW,
            PRIVILEGES.PHYSICAL_SERVER_VIEW,
            PRIVILEGES.NETWORK_DEVICE_VIEW,
            PRIVILEGES.VIEW_ALL_NETWORK_DEVICE,
            PRIVILEGES.STORAGE_DEVICE_VIEW,
            PRIVILEGES.VIEW_ALL_STORAGE_DEVICE
        ]
    },
    {
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "Server Monitoring", privileges: [PRIVILEGES.SERVER_MONITORING_VIEW, PRIVILEGES.SERVER_MONITORING_CREATE, PRIVILEGES.SERVER_MONITORING_UPDATE, PRIVILEGES.SERVER_MONITORING_DELETE, PRIVILEGES.VIEW_OWN_VCENTER_VM_MONITORING] },
            { label: "Server Ping Monitoring", privileges: [PRIVILEGES.SERVER_PING_MONITORING_VIEW, PRIVILEGES.SERVER_PING_MONITORING_CREATE, PRIVILEGES.SERVER_PING_MONITORING_UPDATE, PRIVILEGES.SERVER_PING_MONITORING_DELETE] }
        ]
    },
    {
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "BMS Checklist", privileges: [PRIVILEGES.BMS_CHECKLIST_VIEW, PRIVILEGES.BMS_CHECKLIST_VIEW_ALL_DEPT, PRIVILEGES.BMS_CHECKLIST_CREATE, PRIVILEGES.BMS_CHECKLIST_UPDATE, PRIVILEGES.BMS_CHECKLIST_DELETE] },
            { label: "Cluster Checklist", privileges: [PRIVILEGES.CLUSTER_CHECKLIST_VIEW, PRIVILEGES.CLUSTER_CHECKLIST_VIEW_ALL_DEPT, PRIVILEGES.CLUSTER_CHECKLIST_CREATE, PRIVILEGES.CLUSTER_CHECKLIST_UPDATE, PRIVILEGES.CLUSTER_CHECKLIST_DELETE] },
            { label: "Morning Checklist", privileges: [PRIVILEGES.MORNING_CHECKLIST_VIEW, PRIVILEGES.MORNING_CHECKLIST_CREATE, PRIVILEGES.MORNING_CHECKLIST_UPDATE, PRIVILEGES.MORNING_CHECKLIST_DELETE] }
        ]
    },
    {
    ...
    },
    {
        ...
        subItemPrivileges: [
            { label: "IP List", privileges: [PRIVILEGES.IP_LIST_VIEW] },
            { label: "Phone Directory", privileges: [PRIVILEGES.PHONE_DIRECTORY_VIEW] }
        ]
    },
    {
