  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        error.response?.data?.detail || "Failed to fetch inventory",
      );
    }
  },
);
...
export const bulkCreateInventory = createAsyncThunk(
  ...
  async (file: File, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.detail || "Failed to bulk create items",
      );
    }
  },
);
  ...
  async (
    {
      ...
      id: string;
      data: { givenTo: string; date: string; quantity?: number };
    },
    { rejectWithValue },
  ) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.detail || "Failed to check out item",
      );
    }
  },
);
...
export const returnInventoryItem = createAsyncThunk(
  ...
  async (
    { id, data }: { id: string; data: { holderId: string; date: string } },
    { rejectWithValue },
  ) => {
    try {
      ...
      return rejectWithValue(
        error.response?.data?.detail || "Failed to return item",
      );
    }
  },
);
...
export const editInventoryItem = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      return rejectWithValue(
        error.response?.data?.detail || "Failed to edit item",
      );
    }
  },
);
